...
# Posit in the Cloud {#posit-in-the-cloud background-image="_extensions/jthomasmock/positslides/assets/backgrounds/toc-light.png"}

## Posit Cloud {.smaller}

<br> All accounts can now publish outputs directly to Posit Cloud. You can create, host and share apps, documents and APIs right on Posit Cloud. <br>
